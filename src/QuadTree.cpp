//
// Created by Jacopo Gasparetto on 28/09/21.
//

#include "Verlet/QuadTree.h"

bool BoundingBox::contains(const QuadTreeDataPoint &data) const {
...
QuadTreeNode::QuadTreeNode(const BoundingBox &boundingBox) :
